...
<!-- ht-z0gravity banelVideo --> 
    <div class="row">
    <div class="col-lg-11 mx-auto banelVideo">
    ...
    <!-- end-z0gravity banelVideo -->

    <!-- ht-z0gravity slide -->
    <div class="container-fluid">
    <div class="row">
    <div class="col-lg-11 mx-auto">
        <div class="mx-auto blockquoteSlide bg-white shadow rounded">
    ...
    <footer>
    <div class="container">
        <div class="row mx-auto text-center text-md-start text-white">
            <div class="col-lg-9 sitefooter">
                ...
                <div class="row flex-md-row flex-sm-row-reverse">
                <ul class="list-unstyled copyRight justify-content-around">
                    <li class='d-inline-block'><a href="#">© 2019 Globalsi SAS</a></li>
                    <ul class='d-inline-flex justify-content'>
